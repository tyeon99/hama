<template>
  <div
    ...
    :class="{ 'animate__fadeIn': isOffcanvasAni, 'animate__fadeOut': !isOffcanvasAni }" @click="closeFontSizeOffcanvas">
    <div
      ref="offcanvas"
    ...
    >
      <div class="offcanvas-header">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="5" viewBox="0 0 48 5" fill="none">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M0 2.5C0 1.11929 1.11929 0 2.5 0H45.5C46.8807 0 48 1.11929 48 2.5C48 3.88071 46.8807 5 45.5 5H2.5C1.11929 5 0 3.88071 0 2.5Z" fill="#CDCFD0"/>
        </svg>
      </div>
      <div class="offcanvas-body">
        <img width="76" src="~/assets/img/common/fontsize-img.png" alt="글씨 크기 조절 이미지">
  ...
  methods: {
    ...
    increaseFontSize() {
      if (this.fontSizePercent < 130) {
        ...
        this.$eventBus.$emit('fontSizeChange', this.fontSizePercent)
      }
    },
    decreaseFontSize() {
