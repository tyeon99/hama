...
.chatInput__box input {
  @apply w-full h-[57px] bg-[#fff] rounded-[40px] p-[16px_44px] font-medium text-[20px] leading-[24px] text-[#2B2436] shadow-[0px_0px_12px_0px_rgba(0,0,0,0.08)] placeholder:text-[#7139FF];
}
