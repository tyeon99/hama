      ...
      <div class="bottom">
        ...
        >
          ...
          <div
            ...
            @transitionend="scrollEndOpenDetail"
          >
            <div class="line"></div>
            ...
            <div class="detail-btn">
              ...
              <button @click="goLink('/woori/code/main/detail')">자세히 보러가기</button>
            </div>
          </div>
          <!-- ex-detail -->
        </div>
  ...
  methods: {
    ...
    handleExperienceClick(item) {
      if (item.memberType === 'corporate') {
        ...
        this.goLink('/woori/code/vdata'); // 일반회원은 기존대로 이동
      }
    }
  }
}
...
<style scoped>
.mainContent {
  @apply w-full p-[24px_20px_60px] bg-[#F7F5FF];
}
.mainContent__box {
